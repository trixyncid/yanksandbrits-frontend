...
export function AppointmentReportLoadingState() {
  return (
...
export function AppointmentReportErrorState({ onRetry }: StateProps) {
  return (
    <Card className="px-6 py-16 text-center">
      ...
      <p className="mt-2 text-sm text-slate-500">
        Something went wrong while generating the appointment preview.
      </p>
      {onRetry ? (
