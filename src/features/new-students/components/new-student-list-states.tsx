...
type NewStudentListStateProps = {
  onRetry?: () => void
}

export function NewStudentListLoadingState() {
  return (
...
export function NewStudentListErrorState({
  onRetry,
}: NewStudentListStateProps) {
  return (
