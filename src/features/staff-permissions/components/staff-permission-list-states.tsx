...
type StaffPermissionListStateProps = {
  onRetry?: () => void
}

export function StaffPermissionListLoadingState() {
  return (
...
export function StaffPermissionListErrorState({
  onRetry,
}: StaffPermissionListStateProps) {
  return (
