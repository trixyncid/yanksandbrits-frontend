...
type StudentPaymentListStateProps = {
  onRetry?: () => void
}

export function StudentPaymentListLoadingState() {
  return (
...
export function StudentPaymentListErrorState({
  onRetry,
}: StudentPaymentListStateProps) {
  return (
