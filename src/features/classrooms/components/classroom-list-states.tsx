...
type ClassroomListStateProps = {
  onRetry?: () => void
}

export function ClassroomListLoadingState() {
  return (
...
export function ClassroomListErrorState({ onRetry }: ClassroomListStateProps) {
  return (
    <Card className="px-6 py-16 text-center">
      ...
      <p className="mt-2 text-sm text-slate-500">
        Something went wrong while fetching classrooms. You can try again.
      </p>
      {onRetry ? (
